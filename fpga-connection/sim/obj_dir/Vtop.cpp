...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__top__DOT__sdr_core_if{vlSymsp->TOP.__PVT__top__DOT__sdr_core_if}
    , __PVT__top__DOT__uart_tx_stream{vlSymsp->TOP.__PVT__top__DOT__uart_tx_stream}
    , __PVT__top__DOT__uart_rx_stream{vlSymsp->TOP.__PVT__top__DOT__uart_rx_stream}
    , __PVT__top__DOT__protocol_tx{vlSymsp->TOP.__PVT__top__DOT__protocol_tx}
    , __PVT__top__DOT__protocol_rx{vlSymsp->TOP.__PVT__top__DOT__protocol_rx}
    , rootp{&(vlSymsp->TOP)}
{
