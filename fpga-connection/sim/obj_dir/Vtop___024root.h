...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ top__DOT__u_serialiser__DOT__state;
        CData/*1:0*/ top__DOT__u_serialiser__DOT__state_n;
        ...
        CData/*1:0*/ top__DOT__u_decoder__DOT__state;
        CData/*1:0*/ top__DOT__u_decoder__DOT__state_n;
        ...
        CData/*0:0*/ top__DOT__u_engine__DOT__state;
        CData/*0:0*/ top__DOT__u_engine__DOT__state_n;
        CData/*0:0*/ top__DOT__u_engine__DOT__paused_r;
        CData/*0:0*/ top__DOT__u_engine__DOT__paused_n;
        CData/*0:0*/ top__DOT__u_engine__DOT__rsp_fire;
        CData/*0:0*/ top__DOT__u_engine__DOT__req_fire;
        CData/*1:0*/ top__DOT__u_test_core__DOT__state;
        CData/*3:0*/ top__DOT__u_test_core__DOT__burst_cnt;
        CData/*1:0*/ __VdfgTmp_h61863ee6__0;
        CData/*0:0*/ __Vtrigprevexpr___TOP__top__DOT__u_engine__DOT__rsp_fire__0;
        CData/*0:0*/ __Vtrigprevexpr___TOP__top__DOT__u_engine__DOT__req_fire__0;
        CData/*0:0*/ __VstlDidInit;
        CData/*0:0*/ __VstlFirstIteration;
        CData/*0:0*/ __VicoFirstIteration;
        CData/*0:0*/ __Vtrigprevexpr___TOP__top__DOT__u_engine__DOT__rsp_fire__1;
        CData/*0:0*/ __Vtrigprevexpr___TOP__top__DOT__u_engine__DOT__req_fire__1;
        ...
        SData/*9:0*/ top__DOT__u_engine__DOT__poll_cnt;
        SData/*9:0*/ top__DOT__u_engine__DOT__poll_cnt_n;
    ...
    struct {
        ...
        IData/*31:0*/ top__DOT__u_test_core__DOT__burst_num;
        IData/*31:0*/ __Vfunc_top__DOT__u_uart_top__DOT__u_axiluart__DOT__apply_wstrb__0__Vfuncout;
        IData/*31:0*/ __VactIterCount;
        VlWide<17>/*527:0*/ top__DOT__u_serialiser__DOT__pkt;
        VlWide<17>/*527:0*/ top__DOT__u_serialiser__DOT__pkt_n;
        VlWide<17>/*527:0*/ top__DOT__u_decoder__DOT__prot_buf;
        VlWide<17>/*527:0*/ top__DOT__u_decoder__DOT__prot_buf_n;
