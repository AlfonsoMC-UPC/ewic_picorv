...
#
# Script generated by Vivado on Sat May 30 10:53:03 CEST 2026
...
#
# Usage        : aurora_64b66b_0.sh
#                aurora_64b66b_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                aurora_64b66b_0.sh [-reset_run]
#                aurora_64b66b_0.sh [-reset_log]
#                aurora_64b66b_0.sh [-help]
#
...
#                script (type 'aurora_64b66b_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname gtwizard_ultrascale_v1_7_17 -libname xil_defaultlib -libname fifo_generator_v13_2_9 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib fifo_generator_v13_2_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "aurora_64b66b_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./aurora_64b66b_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.aurora_64b66b_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.aurora_64b66b_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alfonso/TFM/ewic-fpga_fpga_connection/ewic-fpga/uart_design.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log aurora_64b66b_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: aurora_64b66b_0.sh [-step]\n\
Usage: aurora_64b66b_0.sh [-lib_map_path]\n\
Usage: aurora_64b66b_0.sh [-reset_run]\n\
Usage: aurora_64b66b_0.sh [-reset_log]\n\
Usage: aurora_64b66b_0.sh [-keep_index]\n\
