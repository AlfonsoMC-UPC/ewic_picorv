...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gtwizard_ultrascale_v1_7_17 -L xil_defaultlib -L fifo_generator_v13_2_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot aurora_64b66b_0 xil_defaultlib.aurora_64b66b_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aurora_64b66b_0.wdb xsim.dir libdpi.so)
