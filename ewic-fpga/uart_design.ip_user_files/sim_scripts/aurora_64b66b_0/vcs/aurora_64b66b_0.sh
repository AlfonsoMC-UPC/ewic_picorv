...
design_libs=(xpm gtwizard_ultrascale_v1_7_17 xil_defaultlib fifo_generator_v13_2_9)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alfonso/TFM/ewic-fpga_fpga_connection/ewic-fpga/uart_design.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key aurora_64b66b_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc aurora_64b66b_0_simv.daidir vcs_lib c.obj)
